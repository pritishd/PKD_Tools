...
def animCurveDrawStyle(style='simple', forceBuffer=True,
    ...
    if style == 'simple':
        ...
        mel.eval(
            'animCurveEditor -edit -showBufferCurves 1 -displayTangents false -displayActiveKeyTangents false graphEditor1GraphEd;')
    elif style == 'full':
        print 'toggleOff'
...
class AnimationUI(object):
    ...
    def _showUI(self):
        ...
        cmds.menuItem(l=LANGUAGE_MAP._AnimationUI_.vimeo_posesaver_advanced,
                      # "Open Vimeo > PoseSaver - Advanced Topics",
                      c="import Red9.core.Red9_General as r9General;r9General.os_OpenFile('https://vimeo.com/66269033')")
        cmds.menuItem(l=LANGUAGE_MAP._AnimationUI_.vimeo_posesaver_blending,
                      # "Open Vimeo > PoseSaver - Blending and maintain spaces",
        ...
        self.uicbCAttrHierarchy = cmds.checkBox('uicbCAttrHierarchy', l=LANGUAGE_MAP._Generic_.hierarchy, al='left',
                                                v=False,
                                                ann=LANGUAGE_MAP._AnimationUI_.copy_attrs_hierarchy_ann,
                                                cc=lambda x: self.__uiCache_addCheckbox('uicbCAttrHierarchy'))
        self.uicbCAttrToMany = cmds.checkBox('uicbCAttrToMany', l=LANGUAGE_MAP._AnimationUI_.copy_to_many, al='left',
                                             v=False,
        ...
        cmds.separator(h=5, style='none')
        cmds.rowColumnLayout(numberOfColumns=3, columnWidth=[(1, 100), (2, 100), (3, 100)],
                             columnSpacing=[(1, 10), (2, 10)], rowSpacing=[(1, 5)])
        # cmds.rowColumnLayout(numberOfColumns=4, columnWidth=[(1, 75), (2, 80), (3, 80), (3, 80)], columnSpacing=[(1, 10), (2, 10)], rowSpacing=[(1,5)])

        self.uicbCKeyHierarchy = cmds.checkBox('uicbCKeyHierarchy', l=LANGUAGE_MAP._Generic_.hierarchy, al='left',
                                               v=False,
                                               ann=LANGUAGE_MAP._AnimationUI_.copy_keys_hierarchy_ann,
                                               cc=lambda x: self.__uiCache_addCheckbox('uicbCKeyHierarchy'))
        self.uicbCKeyToMany = cmds.checkBox('uicbCKeyToMany', l=LANGUAGE_MAP._AnimationUI_.copy_to_many, al='left',
                                            v=False,
        ...
        self.uicbCKeyAnimLay = cmds.checkBox('uicbCKeyAnimLay', l=LANGUAGE_MAP._AnimationUI_.copy_keys_merge_layers,
                                             al='left', v=False,
        ...
        self.uiffgCKeyStep = cmds.floatFieldGrp('uiffgCKeyStep', l=LANGUAGE_MAP._AnimationUI_.offset, value1=0,
                                                cw2=(40, 50))
        cmds.setParent(self.AnimLayout)
        ...
        self.uicbSnapPreCopyKeys = cmds.checkBox('uicbSnapPreCopyKeys', l=LANGUAGE_MAP._AnimationUI_.pre_copykeys,
                                                 al='left',
                                                 ann=LANGUAGE_MAP._AnimationUI_.pre_copykeys_ann,
                                                 en=False, v=True)
        self.uiifgSnapStep = cmds.intFieldGrp('uiifgSnapStep', l=LANGUAGE_MAP._AnimationUI_.frmstep, en=False, value1=1,
                                              cw2=(45, 30),
                                              ann=LANGUAGE_MAP._AnimationUI_.frmstep_ann)

        self.uicbSnapHierarchy = cmds.checkBox('uicbSnapHierarchy', l=LANGUAGE_MAP._Generic_.hierarchy, al='left',
                                               v=False,
        ...
        self.uicbSnapPreCopyAttrs = cmds.checkBox(l=LANGUAGE_MAP._AnimationUI_.pre_copyattrs, al='left', en=False,
                                                  v=True,
                                                  ann=LANGUAGE_MAP._AnimationUI_.pre_copyattrs_ann)
        self.uiifSnapIterations = cmds.intFieldGrp('uiifSnapIterations', l=LANGUAGE_MAP._AnimationUI_.iteration,
                                                   en=False, value1=1, cw2=(45, 30),
        ...
        cmds.rowColumnLayout(numberOfColumns=4, columnWidth=[(1, 100), (2, 55), (3, 55), (4, 100)],
                             columnSpacing=[(1, 10), (3, 5)])
        ...
        self.uiffgStabStep = cmds.floatFieldGrp('uiffgStabStep', l=LANGUAGE_MAP._AnimationUI_.step, value1=1,
                                                cw2=(40, 50),
        ...
        cmds.rowColumnLayout(numberOfColumns=3, columnWidth=[(1, 100), (2, 100), (3, 100)],
                             columnSpacing=[(1, 10), (2, 10), (3, 5)], rowSpacing=[(1, 5), (2, 5)])
        ...
        self.uicbTimeOffsetPlayback = cmds.checkBox('uicbTimeOffsetTimelines',
                                                    l=LANGUAGE_MAP._AnimationUI_.offset_timelines,
        ...
        self.uicbTimeOffsetFlocking = cmds.checkBox('uicbTimeOffsetFlocking',
                                                    l=LANGUAGE_MAP._AnimationUI_.offset_flocking, al='left', en=True,
                                                    v=False,
                                                    ann=LANGUAGE_MAP._AnimationUI_.offset_flocking_ann)
        self.uicbTimeOffsetRandom = cmds.checkBox('uicbTimeOffsetRandom',
                                                  l=LANGUAGE_MAP._AnimationUI_.offset_randomizer,
        ...
        self.uiffgTimeOffset = cmds.floatFieldGrp('uiffgTimeOffset', value1=1,
                                                  ann=LANGUAGE_MAP._AnimationUI_.offset_frms_ann)
        cmds.setParent(self.AnimLayout)
        ...
        self.uitfgSpecificNodeTypes = cmds.textFieldGrp('uitfgSpecificNodeTypes',
                                                        label=LANGUAGE_MAP._AnimationUI_.search_nodetypes, text="",
                                                        cw2=(120, 200),
        ...
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_transform,
                      command=partial(self.__uiCB_addToNodeTypes, 'transform'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_nurbs_curves,
                      command=partial(self.__uiCB_addToNodeTypes, 'nurbsCurve'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_nurbs_surfaces,
                      command=partial(self.__uiCB_addToNodeTypes, 'nurbsSurface'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_joints,
                      command=partial(self.__uiCB_addToNodeTypes, 'joint'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_locators,
                      command=partial(self.__uiCB_addToNodeTypes, 'locator'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_meshes,
                      command=partial(self.__uiCB_addToNodeTypes, 'mesh'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_cameras,
                      command=partial(self.__uiCB_addToNodeTypes, 'camera'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_hikeff,
                      command=partial(self.__uiCB_addToNodeTypes, 'hikIKEffector'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.nodetype_blendshape,
                      command=partial(self.__uiCB_addToNodeTypes, 'blendShape'))
        self.uitfgSpecificAttrs = cmds.textFieldGrp('uitfgSpecificAttrs',
                                                    label=LANGUAGE_MAP._AnimationUI_.search_attributes, text="",
                                                    cw2=(120, 200),
                                                    ann=LANGUAGE_MAP._AnimationUI_.search_attributes_ann)
        self.uitfgSpecificPattern = cmds.textFieldGrp('uitfgSpecificPattern',
                                                      label=LANGUAGE_MAP._AnimationUI_.search_pattern, text="",
                                                      cw2=(120, 200),
        ...
        self.uitslFilterPriority = cmds.textScrollList('uitslFilterPriority', numberOfRows=8, allowMultiSelection=False,
                                                       height=60, enable=True,
                                                       append=self.filterSettings.filterPriority)
        cmds.popupMenu()
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.priorities_clear,
                      command=lambda x: self.__uiSetPriorities('clear'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.priorities_set, command=lambda x: self.__uiSetPriorities('set'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.priorities_append,
                      command=lambda x: self.__uiSetPriorities('append'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.priorities_remove,
                      command=lambda x: self.__uiSetPriorities('remove'))
        cmds.menuItem(divider=True)
        ...
        cmds.menuItem(l=LANGUAGE_MAP._AnimationUI_.match_stripprefix,
                      ann=LANGUAGE_MAP._AnimationUI_.match_stripprefix_ann)
        ...
        if r9Setup.mayaVersion() > 2012:  # tcc flag not supported in earlier versions
            self.searchFilter = cmds.textFieldGrp('tfPoseSearchFilter', label=LANGUAGE_MAP._AnimationUI_.search_filter,
                                                  text='',
                                                  cw=((1, 87), (2, 160)),
                                                  ann=LANGUAGE_MAP._AnimationUI_.search_filter_ann,
                                                  tcc=lambda x: self.__uiCB_fillPoses(
                                                      searchFilter=cmds.textFieldGrp('tfPoseSearchFilter', q=True,
                                                                                     text=True)))
        else:
            self.searchFilter = cmds.textFieldGrp('tfPoseSearchFilter', label=LANGUAGE_MAP._AnimationUI_.search_filter,
                                                  text='',
                                                  ...
                                                  ann=LANGUAGE_MAP._AnimationUI_.search_filter_ann,
                                                  cc=lambda x: self.__uiCB_fillPoses(
                                                      searchFilter=cmds.textFieldGrp('tfPoseSearchFilter', q=True,
                                                                                     text=True)))
        ...
        self.uicbPoseSpace = cmds.checkBox('uicbPoseSpace',
                                           l=LANGUAGE_MAP._AnimationUI_.pose_maintain_parents, al='left', en=True,
                                           v=False,
                                           cc=lambda *x: self.__uiCache_addCheckbox('uicbPoseSpace'))
        cmds.setParent(self.poseUILayout)
        cmds.separator(h=5, style='none')
        self.uiflPoseRelativeFrame = cmds.frameLayout('PoseRelativeFrame',
                                                      label=LANGUAGE_MAP._AnimationUI_.pose_rel_methods, cll=True,
                                                      en=False)
        ...
        self.uiflPosePointFrame = cmds.frameLayout('PosePointCloud', label='Pose Point Cloud', cll=True, cl=True,
                                                   en=True)
        ...
        cmds.separator(h=10, style='none')
        self.r9strap = cmds.iconTextButton('r9strap', style='iconOnly', bgc=(0.7, 0, 0),
    ...
    def __uiCB_setPriorityFlag(self, *args):
        ...
        if not cmds.textScrollList('uitslFilterPriority', q=True, ai=True):
            log.warning(
                "Internal Node Priority list is empty, you can't set this flag without something in the Priority list itself")
    ...
    def __uiSetPriorities(self, mode='set', *args):
        ...
        if mode == 'set' or mode == 'append':
            ...
            cmds.textScrollList('uitslFilterPriority', e=True,
                                append=[r9Core.nodeNameStrip(node) for node in cmds.ls(sl=True)])
    ...
    def __uiCB_fillPoses(self, rebuildFileList=False, searchFilter=None, sortBy='name', *args):
        ...
        if not self.poseGridMode == 'thumb':
            ...
            for pose in r9Core.filterListByString(self.poses, searchFilter,
                                                  matchcase=False):  # self.buildFilteredPoseList(searchFilter):
    ...
    def __uiCB_PosePopup(self):
        ...
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_blender, p=parent,
                      command=partial(self.__uiCall, 'PoseBlender'))
        cmds.menuItem(divider=True, p=parent)
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_delete, en=enableState, p=parent,
                      command=partial(self.__uiPoseDelete))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_rename, en=enableState, p=parent,
                      command=partial(self.__uiPoseRename))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_selectinternal, p=parent,
                      command=partial(self.__uiPoseSelectObjects))

        cmds.menuItem(divider=True, p=parent)
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_update_pose, en=enableState, p=parent,
                      command=partial(self.__uiPoseUpdate, False))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_update_pose_thumb, en=enableState, p=parent,
                      command=partial(self.__uiPoseUpdate, True))

        if self.poseGridMode == 'thumb':
            cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_update_thumb, p=parent,
                          command=partial(self.__uiPoseUpdateThumb))

        cmds.menuItem(divider=True, p=parent)
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_add_subfolder, en=enableState, p=parent,
                      command=partial(self.__uiPoseMakeSubFolder))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_refresh, en=True, p=parent,
                      command=lambda x: self.__uiCB_fillPoses(rebuildFileList=True))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_openfile, p=parent,
                      command=partial(self.__uiPoseOpenFile))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_opendir, p=parent,
                      command=partial(self.__uiPoseOpenDir))
        cmds.menuItem(divider=True, p=parent)
        cmds.menuItem('red9PoseCompareSM', l=LANGUAGE_MAP._AnimationUI_.pose_rmb_compare, sm=True, p=parent)
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_compare_skel, p='red9PoseCompareSM',
                      command=partial(self.__uiCall, 'PoseCompareSkelDict'))
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_compare_posedata, p='red9PoseCompareSM',
                      command=partial(self.__uiCall, 'PoseComparePoseDict'))

        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_copyhandler, en=enableState, p=parent,
                      command=partial(self.__uiPoseAddPoseHandler))
        cmds.menuItem(divider=True, p=parent)
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_copypose, en=enableState, p=parent,
                      command=partial(self.__uiPoseCopyToProject))

        cmds.menuItem(divider=True, p=parent)
        cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_switchmode, p=parent,
                      command=self.__uiCB_switchPoseMode)

        if self.poseGridMode == 'thumb':
            cmds.menuItem(divider=True, p=parent)
            cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_grid_small, p=parent,
                          command=partial(self.__uiCB_setPoseGrid, 'small'))
            cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_grid_med, p=parent,
                          command=partial(self.__uiCB_setPoseGrid, 'medium'))
            cmds.menuItem(label=LANGUAGE_MAP._AnimationUI_.pose_rmb_grid_large, p=parent,
                          command=partial(self.__uiCB_setPoseGrid, 'large'))
                    ...
                    if poseHandlers:
                        for handler in poseHandlers:
                            if handler.endswith('_poseHandler.py'):
                                ...
                                cmds.menuItem(
                                    label='Add Subfolder : %s' % handler.replace('_poseHandler.py', '').upper(),
    ...
    def addPopupMenusFromFolderConfig(self, parentPopup):
        ...
        if poseHandler:
            ...
            if [func for name, func in inspect.getmembers(tempPoseFuncs, inspect.isfunction) if
                name == 'posePopupAdditions']:
    ...
    def __uiCB_gridResize(self, *args):
        if r9Setup.mayaVersion() >= 2010:
            cells = int(
                cmds.scrollLayout('uiglPoseScroll', q=True, w=True) / cmds.gridLayout('uiglPoses', q=True, cw=True))
    ...
    def __uiCB_setPoseRootNode(self, *args):
        ...
        # fill the cache up for the ini file
        self.ANIM_UI_OPTVARS['AnimationUI']['poseRoot'] = cmds.textFieldButtonGrp('uitfgPoseRootNode', q=True,
                                                                                  text=True)
        self.__uiCache_storeUIElements()
    ...
    def __uiPoseMakeSubFolder(self, handlerFile=None, *args):
        ...
        if handlerFile:
            promptstring = 'New %s POSE Folder Name' % os.path.basename(handlerFile).replace('_poseHandler.py',
                                                                                             '').upper()
        result = cmds.promptDialog(
            title=promptstring,
            message='Enter Name:',
    ...
    def __CopyAttrs(self):
        ...
        if cmds.checkBox(self.uicbCAttrHierarchy, q=True, v=True):
            if self.kws['toMany']:
                ...
                AnimFunctions(matchMethod=self.matchMethod).copyAttributes(nodes=None,
                                                                           filterSettings=self.filterSettings,
                                                                           **self.kws)
        else:
            print self.kws
    ...
    def __CopyKeys(self):
        ...
        if cmds.checkBox(self.uicbCKeyHierarchy, q=True, v=True):
            if self.kws['toMany']:
                ...
                AnimFunctions(matchMethod=self.matchMethod).copyKeys(nodes=None, filterSettings=self.filterSettings,
                                                                     **self.kws)
        else:
    ...
    def __Snap(self):
        ...
        if cmds.checkBox(self.uicbSnapHierarchy, q=True, v=True):
            ...
            AnimFunctions(matchMethod=self.matchMethod).snapTransform(nodes=None, filterSettings=self.filterSettings,
                                                                      **self.kws)
        else:
...
class AnimFunctions(object):
    ...
    def copyKeys(self, nodes=None, time=(), pasteKey='replace', attributes=None,
        ...
        log.debug(
            'CopyKey params : nodes=%s : time=%s : pasteKey=%s : attributes=%s : filterSettings=%s : matchMethod=%s' \
...
preCopyAttrs=%s : filterSettings=%s : matchMethod=%s : prioritySnapOnly=%s : snapTransforms=%s : snapRotates=%s' \
                        ...
                        for t in timeLineRangeProcess(time[0], time[1], step, incEnds=True):
                            ...
                            while not dataAligned:
                                for src, dest in self.nodesToSnap:  # nodeList.MatchedPairs:
                                    ...
                                    log.debug('Snapfrm %s : %s - %s : to : %s' % (
                                    str(t), r9Core.nodeNameStrip(src), dest, src))
    ...
    def snap(nodes=None, snapTranslates=True, snapRotates=True):
        ...
        for node in nodes[1:]:
            cmds.SnapTransforms(source=nodes[0], destination=node, snapTranslates=snapTranslates,
                                snapRotates=snapRotates)
    ...
    def stabilizer(nodes=None, time=(), step=1, trans=True, rots=True):
        ...
        for time in timeRange:
            ...
            cmds.SnapTransforms(source=snapRef, destination=destObj, timeEnabled=True, snapTranslates=trans,
                                snapRotates=rots)
            try:
                if trans:
...
class RandomizeKeys(object):
    ...
    def __init__(self):
        ...
        self.displayActiveKeyTangents = cmds.animCurveEditor('graphEditor1GraphEd', q=True,
                                                             displayActiveKeyTangents=True)
    ...
    def __uicb_setRanges(self, *args):
        cmds.floatSliderGrp('fsg_randfloatValue', e=True,
                            maxValue=args[0])  # cmds.floatField('ffg_rand_intMax',q=True,v=True))
    ...
    def __storePrefs(self, *args):
        if cmds.window(self.win, exists=True):
            ...
            cmds.optionVar(
                floatValue=('red9_randomizer_frmStep', cmds.floatFieldGrp('ffg_rand_frmStep', q=True, v1=True)))
            ...
            for curve in curves:
                ...
                for t, v in zip(keyData[::2], keyData[1::2]):
                    if percent:
                        ...
                        log.debug(
                            'Percent data : randomRange=%f>%f, percentage=%f' % (randomRange[0], randomRange[1], damp))
...
class MirrorHierarchy(object):
    ...
    def __init__(self, nodes=[], filterSettings=None, **kws):
        ...
        self.mirrorDict = {'Centre': {}, 'Left': {}, 'Right': {}, "Unique": {}}
        ...
        for node in self.indexednodes:
            try:
                ...
                if str(index) in self.mirrorDict[side]:
                    log.warning(
                        'Mirror index ( %s : %i ) already assigned : currently node : %s,  duplicate node : %s' %
                        (side, index,
        ...
        with AnimationLayerContext(self.indexednodes, mergeLayers=self.mergeLayers, restoreOnExit=False):
            ...
            for index, leftData in self.mirrorDict['Left'].items():
                if not index in self.mirrorDict['Right'].keys():
                    log.warning('No matching Index Key found for Left mirrorIndex : %s >> %s' % (
                    index, r9Core.nodeNameStrip(leftData['node'])))
                else:
            ...
            for node in nodesToMap:
                ...
                for index, leftData in self.mirrorDict['Left'].items():
                    if r9Core.matchNodeLists([node], [leftData['node']], matchMethod=matchMethod):
                        log.debug(
                            'NodeMatched: %s, Side=Left, index=%i, axis=%s' % (node, int(index), leftData['axis']))
                ...
                if not found:
                    for index, rightData in self.mirrorDict['Right'].items():
                        if r9Core.matchNodeLists([node], [rightData['node']], matchMethod=matchMethod):
                            log.debug('NodeMatched: %s, Side=Right, index=%i, axis=%s' % (
                            node, int(index), rightData['axis']))
                ...
                if not found:
                    for index, centreData in self.mirrorDict['Centre'].items():
                        if r9Core.matchNodeLists([node], [centreData['node']], matchMethod=matchMethod):
                            log.debug('NodeMatched: %s, Side=Centre, index=%i, axis=%s' % (
                            node, int(index), centreData['axis']))
                            if r9Core.decodeString(centreData['axisAttr']):
                                ...
                                self.setMirrorIDs(node, side='Centre', slot=int(index),
                                                  axis=axis)  # ','.join(centreData['axis']))
                            else:
                                self.setMirrorIDs(node, side='Centre', slot=int(index))
                            break
...
class MirrorSetup(object):
    ...
    def __saveMirrorSetups(self):
        filepath = \
        cmds.fileDialog2(fileFilter="mirrorMap Files (*.mirrorMap *.mirrorMap);;", okc='Save', cap='Save MirrorSetups')[
            0]
        self.mirrorClass.nodes = cmds.ls(sl=True)
    ...
    def __loadMirrorSetups(self):
        filepath = \
        cmds.fileDialog2(fileFilter="mirrorMap Files (*.mirrorMap *.mirrorMap);;", okc='Load', cap='Load MirrorSetups',
                         fileMode=1)[0]
        if cmds.checkBox('mirrorSaveLoadHierarchy', q=True, v=True):
            self.mirrorClass.nodes = cmds.ls(sl=True, l=True)
            self.mirrorClass.loadMirrorSetups(filepath=filepath,
                                              clearCurrent=cmds.checkBox('mirrorClearCurrent', q=True, v=True))
        else:
...
class CameraTracker():
    ...
    def cameraTrackView(start=None, end=None, step=None, fixed=True, keepOffset=False):
        ...
        if fixed:
            ...
            if keepOffset:
                ...
                offset = [(cachedTransform[0] - shifted[0]), (cachedTransform[1] - shifted[1]),
                          (cachedTransform[2] - shifted[2])]
    ...
    def _showUI(self):
        ...
        cmds.separator(h=15, style='none')
        cmds.checkBox('CBMaintainCurrent', l=LANGUAGE_MAP._CameraTracker_.maintain_frame, v=True,
                      cc=partial(self.__storePrefs))
        cmds.separator(h=15, style='none')
        ...
        if self.fixed:
            ...
            cmds.button('cameraTrackTrack', label=LANGUAGE_MAP._CameraTracker_.track,
