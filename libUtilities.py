...
@brief Miscellenous package with useful commands that is imported by other packages. @details As the package gets more complex, we will refactor common methods into specialised packages
'''

from maya import cmds,mel
import pymel.core as pm
import libXml,libFile
reload(libXml)
import os
import tempfile

def get_selected(stringMode=False,commandMode=True):
    ...
    @param commandMode (bool) Commandmode will force the stop the process. If set to false then a warning will be given instead of erroring out.
    '''
